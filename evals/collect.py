...
if __name__ == "__main__":
    ...
    # ====== RUN CUSTOM AGENT ======
    car_custom = CollectAgentResult(data_custom, llm_model=llm_model)
    car_custom.run_agent(embed_to_vectorstore=False, save_to_storage=False)
    ...
    # ====== RUN BASELINE AGENT ======
    car_baseline = CollectAgentResult(data_baseline, llm_model=llm_model, custom_agent=False)
