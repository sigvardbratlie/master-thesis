...
// Level 1 (no project selected): renderMainSidebar()
// Level 2 (project selected):    renderSidebar()
// ============================================================
...
// ── Level 1 — company-level navigation ──────────────────────
...
export function renderMainSidebar() {
    ...
    <aside id="sidebar" class="h-screen w-64 fixed left-0 top-0 z-50 bg-surface-container-low flex flex-col p-6 font-body text-sm">
      ...
      <div class="mb-10">
        <div class="flex items-center gap-3">
          ...
          <div>
            <h1 class="font-headline font-black text-primary-container text-base leading-none">Juris Counsel</h1>
            <p class="text-[10px] uppercase tracking-widest text-on-surface-variant mt-0.5">Legal Curator</p>
          </div>
        </div>
      </div>
      ...
      <div class="pt-6 border-t border-outline-variant/15">
        <button id="btn-user-menu"
          class="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-surface-container-lowest/60 transition-colors text-left">
...
export function bindMainSidebarEvents() {
...
// ── Level 2 — project-level navigation ──────────────────────
