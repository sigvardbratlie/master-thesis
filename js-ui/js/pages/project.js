...
const ADD_FIELDS = {
  ...
  deadline: [
    ...
    { id: 'description',   label: 'Description',   type: 'textarea',      required: true,  placeholder: 'Describe the deadline…' },
  ...
  event: [
    ...
    { id: 'category',         label: 'Category',     type: 'text',          required: true,  placeholder: 'e.g. Contract, Litigation' },
    { id: 'description',      label: 'Description',  type: 'textarea',      required: true,  placeholder: 'Describe the event…' },
    { id: 'significance',     label: 'Significance', type: 'select',        required: true,  options: SIGNIFICANCE_OPTIONS, default: 'medium', allowEmpty: false },
  ...
  claim: [
    ...
    { id: 'factual_basis',       label: 'Factual Basis',      type: 'textarea', required: true,  placeholder: 'Facts supporting the claim…' },
    { id: 'legal_basis',         label: 'Legal Basis',        type: 'text',   required: true,  placeholder: 'e.g. §10-1 avtaleloven' },
    ...
    { id: 'relief_sought',       label: 'Relief Sought',      type: 'text',   required: true,  placeholder: 'e.g. Damages, Injunction' },
  ...
  damage: [
    ...
    { id: 'basis',        label: 'Basis',        type: 'textarea', required: true,  placeholder: 'Describe the basis…' },
